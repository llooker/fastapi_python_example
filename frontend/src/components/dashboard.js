    ...
    LookerEmbedSDK.init(
      ...
      { 
       ...
       ,headers: [
           ...
           //Uncomment this if you are having some CORS trouble with the SDK call
        //,{ name: 'access-control-allow-origin', value: '*' }
        ]
        //uncomment this line if your react is set up to automatically append auth information to the header
